...
class DepartmentViewSet(viewsets.ModelViewSet):
    ...
    def departments(self, request, pk=None):
        ...
        if not organisation:
            return Response(
                {"error": "User does not belong to any organisation"},
...
class TeamViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        manager_id = self.request.data["manager"]

        serializer.save()
        team = Team.objects.get(name=self.request.data["name"])

        member = TeamMember.objects.create(
            team=team, user_id=manager_id, role="manager"
        )
    ...
    def add_member(self, request, pk=None):
        ...
        member = TeamMember.objects.create(team=team, user_id=user_id, role=role)
